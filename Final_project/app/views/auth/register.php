     ...
     <div class="container-sm bg-white rounded-3 shadow-sm p-3" style="max-width: 50%;">
          ...
          <form action="" method="post">
               <div class="input-group mb-3">
                    <i class="bi bi-person input-group-text" id="basic-addon1"></i>
               ...
               <div class="input-group mb-3">
                    <i class="bi bi-lock input-group-text" id="basic-addon1"></i>
                    <input type="password" name="password_confirmation" class="form-control" placeholder="Password confirmation" aria-label="Username" aria-describedby="basic-addon1" required>
               </div>
               <button class="btn btn-primary mb-3" style="width: 100%;" name="register">Register</button>
               <div>
                    <span class="text-center d-block fw-medium text-secondary">Sudah punya akun ? <a href="login.php" class="text-decoration-none">Login sekarang!</a></span>
               </div>
          </form>
     </div>
